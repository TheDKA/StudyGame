...
namespace StudyGame.Managers
{
    public static class ResourceManager
    {
        ...
        public static object LoadBackgrounds(string fileName)
        {
            return LoadResources($@"images/backgrounds/{fileName}", "sprite");
        }

        // TODO: [ ] Create a new loading way without use "optionalPath"
        public static object LoadSprites(string fileName, string optionalPath)
        {
            return LoadResources($@"images/characters/{(optionalPath != null ? optionalPath + "/" : "")}{fileName}", "sprite");
        }

        public static object LoadFont(string fileName)
        {
            return LoadResources($@"fonts/{fileName}", "font");
        }
