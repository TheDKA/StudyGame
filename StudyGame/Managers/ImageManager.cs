...
namespace StudyGame.Managers
{
    public static class ImageManager
    {
        ...
        #region Methods
        public static Texture2D LoadBackgrounds(string fileName)
        {
            return LoadResources($@"images/backgrounds/{fileName}");
        }

        public static Texture2D LoadSprites(string fileName)
        {
            return LoadResources($@"images/characters/{fileName}");
        }
